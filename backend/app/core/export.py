...
def to_excel_bytes(response: RecommendationResponse, request: ExportRequest | None = None) -> bytes:
    ...
    for line, decision in selected:
        ...
        rows.append({
            ...
            "Товарная группа ekt.kz": line.product_category or "",
            "Подкатегория ekt.kz": line.product_subcategory or "",
            "Бренд ekt.kz": line.product_brand or "",
            "Карточка ekt.kz": line.product_url or "",
            "Дата справочника ekt.kz": line.catalog_fetched_at or "",
    ...
    settings_rows = [
        ...
        ("Товарная группа ekt.kz", response.product_category or "Все"),
