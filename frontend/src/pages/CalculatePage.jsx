...
export default function CalculatePage({
  ...
  const disabled = submitting || Boolean(pending) || !meta || !active
  ...
  return (
    <>
      ...
      <section className="parameters-panel" aria-labelledby="parameters-title">
        ...
        <p id="catalog-filter-help" className="help">
          Группы EKT доступны только для сопоставленных товаров. Для полного ассортимента оставьте все группы.
        </p>
